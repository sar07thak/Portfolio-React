    ...
    <>
      <div className="py-10 justify-center items-center  text-white">
        <div className="flex flex-col justify-center  px-16 py-16 lg:py-20 ">
          <p className="para md:text-5xl text-2xl mb-5 lg:text-7xl " onMouseMove={handleMouseMove}>Hello 👋</p>
          <p className="para md:text-5xl text-2xl mb-5 lg:text-7xl ">
            I'm Sarthak Gupta - Curious
          </p>
          <p className="para md:text-5xl text-2xl mb-5 lg:text-7xl">Frontend Developer</p>
          <p className="para md:text-5xl text-2xl mb-5 lg:text-7xl">
