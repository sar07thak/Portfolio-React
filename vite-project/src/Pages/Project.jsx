        ...
        <div className="flex flex-col justify-center  w-full">
          ...
          <div className="mt-10 grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-3 justify-between gap-10">
            {projects.map((project) => (
              <div key={project.id}>
                <img
                  src={`https://images.unsplash.com/photo-1656188505561-19f1a1b6cda8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80`} // Replace with actual image URLs
